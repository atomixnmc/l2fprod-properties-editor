 ...
 * to container:
 * <ul>
 * <li>container.add(component); <br>in this case, the component will be sized
 ...
 * <li>container.add(component, "*"); <br>in this case, the component will take
 * the remaining space. if several components use the "*" constraint the space
 * will be divided among the components.
 * </ul>
 *
